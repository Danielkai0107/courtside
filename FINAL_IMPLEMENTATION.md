...
- ko_32: 32 強淘汰賽（17-32 人）
- ko_universal: 通用淘汰賽（2-999 人）

### 4. 局數制記分系統

**ScoringConsole**

- 顯示局數表格（第 1 局、第 2 局、第 3 局）
- 顯示規則說明（3 戰 2 勝、每局 21 分）
- 支援 Deuce 和封頂規則
- 自動判定局勝負和比賽勝負
...
| 3-4    | 4 強淘汰 (ko_4)                    | 淘汰 |
| 6-8    | 8 強淘汰 (ko_8)                    | 淘汰 |
| 6-11   | 2 組 → 準決賽 (group_to_semi_6_11) | 混合 |
| 12-16  | 16 強淘汰 (ko_16)                  | 淘汰 |
| 13-20  | 4 組 →8 強 (group_to_qf_13_20)     | 混合 |
| 17-32  | 32 強淘汰 (ko_32) ⭐               | 淘汰 |
