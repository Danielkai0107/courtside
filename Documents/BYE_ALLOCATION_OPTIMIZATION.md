...
第一輪（R16）：
  ...
  Match 2: 測試選手 C vs 測試選手 D  ← 真實比賽
  Match 3: 測試選手 E vs 測試選手 F  ← 真實比賽
  Match 4: 測試選手 G vs 測試選手 H  ← 真實比賽
  Match 5: 測試選手 I vs 測試選手 J  ← 真實比賽
  Match 6: BYE vs BYE                 ← 跳過
...
3. **添加詳細日誌**
   ```
   🎯 優化配對：5 場真實比賽 + 0 場輪空
   ⏭️ Skipping BYE vs BYE match at position 6
   ```
